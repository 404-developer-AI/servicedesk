...
describe("LoginPage", () => {
  ...
  it("renders the credentials form and the Microsoft placeholder button", () => {
    render(<LoginPage />);
    expect(screen.getByPlaceholderText("you@example.com")).toBeInTheDocument();
    expect(screen.getByTestId("m365-signin")).toBeInTheDocument();
  });

  it("shows a toast and does nothing when the Microsoft button is clicked", () => {
    render(<LoginPage />);
    fireEvent.click(screen.getByTestId("m365-signin"));
