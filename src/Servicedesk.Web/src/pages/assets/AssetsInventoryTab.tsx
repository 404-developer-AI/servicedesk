...
/// Assets → Assets tab (the v0.0.52 inventory list). Hosted by
/// <c>AssetsPage</c> since v0.1.10, which owns the page header and the
/// tab bar; this component owns the filters, the table and the sync
/// controls for the agent mirror.
export function AssetsInventoryTab() {
