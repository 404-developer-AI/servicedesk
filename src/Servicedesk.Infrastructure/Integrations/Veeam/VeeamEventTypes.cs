...
public static class VeeamEventTypes
{
    ...
    public const string SecurityCompanyLinked    = "integration.veeam.company.linked";
    public const string SecurityCompanyUnlinked  = "integration.veeam.company.unlinked";
